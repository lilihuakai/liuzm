...
class website(osv.osv):
    ...
    _columns = {
        ...
        'social_beian': fields.char('Website Beian Number', help="Website Beian Number （China only）."),
        'social_statis': fields.char('Website Statistics Account', help="Website Statistics Account, like cnzz.com"),
    }

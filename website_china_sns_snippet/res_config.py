...
class website_config_settings(osv.osv_memory):
    ...
    _columns = {        
        ...
        'social_beian': fields.related('website_id', 'social_beian', type="char", string='Website Beian Number'),
        'social_statis': fields.related('website_id', 'social_statis', type="char", string='Website Statistics Account'),
    }
